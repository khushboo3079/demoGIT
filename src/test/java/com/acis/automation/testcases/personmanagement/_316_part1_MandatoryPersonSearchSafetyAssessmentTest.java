...
public class _316_part1_MandatoryPersonSearchSafetyAssessmentTest extends TestBase{
	
	final static Logger logger = LoggerFactory.getLogger(_316_part1_MandatoryPersonSearchSafetyAssessmentTest.class);
	public _316_part1_MandatoryPersonSearchSafetyAssessmentTest() throws AcisException {
		super();
