...
public class _126_PersonalIdentifierTest extends TestBase{
	final static Logger logger = LoggerFactory.getLogger(_126_PersonalIdentifierTest.class);

	public _126_PersonalIdentifierTest() throws AcisException {
		super();
