...
public class _0645_PersonSearchUpdates extends TestBase {

	public _0645_PersonSearchUpdates() throws AcisException{
	...
	final static Logger logger = LoggerFactory.getLogger(_0645_PersonSearchUpdates.class);
