...
public class _063_PersonEducationTest extends TestBase{
	final static Logger logger = LoggerFactory.getLogger(_063_PersonEducationTest.class);

	public _063_PersonEducationTest() throws AcisException {
		super();
