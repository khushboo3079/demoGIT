...
public class _0883_ClearOutSearchCriteriaTestCase extends TestBase {

	public _0883_ClearOutSearchCriteriaTestCase() throws AcisException {
		super();
	 ...
	 */
	final static Logger logger = LoggerFactory.getLogger(_0883_ClearOutSearchCriteriaTestCase.class);
