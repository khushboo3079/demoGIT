...
public class _1015_PopulateNewPersonPersonSearchTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_1015_PopulateNewPersonPersonSearchTest.class);

	public _1015_PopulateNewPersonPersonSearchTest() throws AcisException {
		super();
