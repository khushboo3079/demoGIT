...
public class _0306_RecordTypeTestCase extends TestBase {
	final static Logger logger = LoggerFactory.getLogger(_0306_RecordTypeTestCase.class);

	public _0306_RecordTypeTestCase() throws AcisException {
		super();
	...
	public void CreatePlacementAccountAdmin() throws AcisException, InterruptedException, IOException {
		...
		userLogin.loginUserToApplication(testData.get(Constants.LOGINPAGE_SHEET).get("licensingWorkerUserName"),
				testData.get(Constants.LOGINPAGE_SHEET).get("licensingWorkerUserName"));
