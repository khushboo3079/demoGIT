...
public class _0207_AdoptionRecruitmentNewChildNotificationTest extends TestBase{

	public _0207_AdoptionRecruitmentNewChildNotificationTest() throws AcisException {
		super();
		// TODO Auto-generated constructor stub
	}
	final static Logger logger = LoggerFactory.getLogger(_0207_AdoptionRecruitmentNewChildNotificationTest.class);
	...
	@Test(priority=0,description = "S-0207 Provider Management - Adoption Recruitment-New Child Notification", groups = { "Medium",
	...
	@Test( description = "S-0207 Provider Management - Adoption Recruitment-New Child Notification- Foster Care Case Add Person", groups = {
	...
	public void fosterCareCreatePerson() throws AcisException, InterruptedException, IOException {
		try {
			...
			// TODO Auto-generated catch block
			getStackTrace(e,
					"Failed S-0207 Provider Management - Adoption Recruitment-New Child Notification- Foster Care Case Add Person");
		}

	}
	@Test(priority=2,description = "S-0207 Provider Management - Adoption Recruitment-New Child Notification ", groups = { "High", "acisRegression", "Virendra" })
...
@Test(priority=3,description = "S-0207 Provider Management - Adoption Recruitment-New Child Notification ", groups = { "High", "acisRegression", "Virendra" })
