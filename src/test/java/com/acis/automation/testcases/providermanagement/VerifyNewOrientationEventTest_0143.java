...
public class VerifyNewOrientationEventTest_0143 extends TestBase {

	public VerifyNewOrientationEventTest_0143() throws AcisException{
	...
	final static Logger logger = LoggerFactory.getLogger(VerifyNewOrientationEventTest_0143.class); 
