...
public class _0224_AccountRegistrationTest extends TestBase {
	final static Logger logger = LoggerFactory.getLogger(_0224_AccountRegistrationTest.class);

	public _0224_AccountRegistrationTest() throws AcisException {
		super();
