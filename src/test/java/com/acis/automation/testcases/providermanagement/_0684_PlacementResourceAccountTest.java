...
public class _0684_PlacementResourceAccountTest extends TestBase {
	final static Logger logger = LoggerFactory.getLogger(_0684_PlacementResourceAccountTest.class);

	public _0684_PlacementResourceAccountTest() throws AcisException {
		super();
