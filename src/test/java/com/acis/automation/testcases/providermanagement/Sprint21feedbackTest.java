...
public class Sprint21feedbackTest extends TestBase {

	public Sprint21feedbackTest() throws AcisException {
		super();
	...
	final static Logger logger = LoggerFactory.getLogger(Sprint21feedbackTest.class);
