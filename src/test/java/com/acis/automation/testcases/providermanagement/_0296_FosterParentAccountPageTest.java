...
public class _0296_FosterParentAccountPageTest extends TestBase {
	final static Logger logger = LoggerFactory.getLogger(_0296_FosterParentAccountPageTest.class);

	public _0296_FosterParentAccountPageTest() throws AcisException {
		super();
