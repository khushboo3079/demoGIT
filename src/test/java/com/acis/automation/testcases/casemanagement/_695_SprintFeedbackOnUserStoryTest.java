...
public class _695_SprintFeedbackOnUserStoryTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_695_SprintFeedbackOnUserStoryTest.class);

	public _695_SprintFeedbackOnUserStoryTest() throws AcisException {
		super();
	...
	public void FeedbackUserStory() throws AcisException {
		try {
			...
			collateralTypeInteractionPage.selectRadioButton();
			collateralTypeInteractionPage.selectDate();
			collateralTypeInteractionPage.setText("CollateralName", "name");
			collateralTypeInteractionPage.setSubtype("medical");
			collateralTypeInteractionPage.setText("Narrative", "name");
			collateralTypeInteractionPage.setText("ProfessionalOpinion", "name");
