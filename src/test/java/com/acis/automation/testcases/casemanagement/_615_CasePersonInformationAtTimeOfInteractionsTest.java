...
public class _615_CasePersonInformationAtTimeOfInteractionsTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_615_CasePersonInformationAtTimeOfInteractionsTest.class);
	String fosterCaseID;
	public _615_CasePersonInformationAtTimeOfInteractionsTest() throws AcisException {
		super();
