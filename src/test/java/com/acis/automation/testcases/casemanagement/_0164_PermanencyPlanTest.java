...
public class _0164_PermanencyPlanTest extends TestBase {

	public _0164_PermanencyPlanTest() throws AcisException {
		super();
	...
	public void PermanencyEnrollSchoolPlan() throws AcisException, InterruptedException, IOException {
		try {
			if (count==7) {
				...
				collateralTypeInteractionPage.setText("CollateralName", "Demo");
				collateralTypeInteractionPage.setSubtype("medical");
				collateralTypeInteractionPage.setText("Narrative", "Demo");
				collateralTypeInteractionPage.setText("ProfessionalOpinion", "Demo");
