...
public class _0559_SearchPlacementResourceTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_0559_SearchPlacementResourceTest.class);

	public _0559_SearchPlacementResourceTest() throws AcisException {
