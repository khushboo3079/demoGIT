...
public class _0616_CasePersonInformationAtTimeOfPlacementTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_0616_CasePersonInformationAtTimeOfPlacementTest.class);
	public _0616_CasePersonInformationAtTimeOfPlacementTest() throws AcisException {
		super();
