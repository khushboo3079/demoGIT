...
public class AssignInvestigationTest extends TestBase {

	public AssignInvestigationTest() throws AcisException {
		super();
	...
	final static Logger logger = LoggerFactory.getLogger(AssignInvestigationTest.class);
...
//				.provideState(testData.get(Constants.PersonInvovledAllData).get("secondPersonFirstState"));
	...
	public void assignInvestigationUsingInvestigation() throws InterruptedException, AcisException {
