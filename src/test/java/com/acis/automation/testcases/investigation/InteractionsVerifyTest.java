...
public class InteractionsVerifyTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(InteractionsVerifyTest.class);

	public InteractionsVerifyTest() throws AcisException {
		super();
