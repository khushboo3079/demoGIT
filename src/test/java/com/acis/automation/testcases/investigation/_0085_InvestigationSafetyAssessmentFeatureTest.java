...
public class _0085_InvestigationSafetyAssessmentFeatureTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_0085_InvestigationSafetyAssessmentFeatureTest.class);

	public _0085_InvestigationSafetyAssessmentFeatureTest() throws AcisException {
		super();
