...
public class InvestigationCaseTest_0098 extends TestBase {

	public InvestigationCaseTest_0098() throws AcisException {
		super();
	...
	@Test(enabled = false,description = " US:0098 Create Investigation Case - Intake Login Part", groups = { "High", "acisRegression",
			"Mrunal" },priority = 0)

	public void verifyInvestigtaionCaseInfoIntakeLogin() throws AcisException, Exception {
/*
...
//					testData.get(Constants.PersonInvovledAllData).get("firstPersonEmail"));
	...
	@Test(enabled = false,description = " US:0098 Create Investigation Case - Supervisor Approval Part", groups = { "High",
