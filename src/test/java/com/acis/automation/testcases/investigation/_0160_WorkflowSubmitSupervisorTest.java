...
public class _0160_WorkflowSubmitSupervisorTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_0160_WorkflowSubmitSupervisorTest.class);

	public _0160_WorkflowSubmitSupervisorTest() throws AcisException {
		super();
