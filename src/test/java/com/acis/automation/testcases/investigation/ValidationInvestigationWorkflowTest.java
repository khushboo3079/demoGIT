...
public class ValidationInvestigationWorkflowTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(ValidationInvestigationWorkflowTest.class);

	public ValidationInvestigationWorkflowTest() throws AcisException {
		super();
