...
public class _0802_CustomButtonVisibilityforIntakeUsersTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_0802_CustomButtonVisibilityforIntakeUsersTest.class);

	public _0802_CustomButtonVisibilityforIntakeUsersTest() throws AcisException {
		super();
