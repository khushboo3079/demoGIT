...
public class _0023_AssoicatedAllegationsTest extends TestBase {

	public _0023_AssoicatedAllegationsTest() throws AcisException {
		super();
	...
	int count=0;
	final static Logger logger = LoggerFactory.getLogger(_0023_AssoicatedAllegationsTest.class);
