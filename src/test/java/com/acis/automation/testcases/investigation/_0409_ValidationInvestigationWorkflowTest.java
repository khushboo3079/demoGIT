...
public class _0409_ValidationInvestigationWorkflowTest extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(_0409_ValidationInvestigationWorkflowTest.class);

	public _0409_ValidationInvestigationWorkflowTest() throws AcisException {
		super();
	...
	@Test(priority = 0, description = "S-0409:Non-mandatory validations-Investigation Workflow Intake creation", groups = {
...
//					.provideState(testData.get(Constants.PersonInvovledAllData).get("secondPersonFirstState"));
			...
			getStackTrace(e, " Failed S-0409:Non-mandatory validations-Investigation Workflow Intake creation");

		}

	}

	@Test(priority=1,description = "S-0409:Non-mandatory validations-Investigation Workflow Intake creation Allegation Approval", groups = { "Medium",
	...
	public void submitIntake() throws AcisException, InterruptedException, IOException {
		...
		try {
			...
			// TODO Auto-generated catch block
			getStackTrace(e, " Failed S-0409:Non-mandatory validations-Investigation Workflow Intake creation Allegation Approval");

		}
	}
	
	@Test(priority = 2, description = "S-0409:Non-mandatory validations-Investigation Workflow Error Verify", groups = {
	...
	public void investigationFlow() throws AcisException {
		try {
			if (count==2) {
				...
				interview_OmniScriptPage.verifyWarningNotPresent();
				interview_OmniScriptPage.clickSavebutton();
				interview_OmniScriptPage.verifyError();
				...
				collaterals_OmniScriptPage.verifyWarningNotPresent();
				collaterals_OmniScriptPage.clickSaveButton();
				collaterals_OmniScriptPage.verifyError();
				collaterals_OmniScriptPage.closeCollateraltabCheck();
			...
			// TODO Auto-generated catch block
			getStackTrace(e, " Failed S-0409:Non-mandatory validations-Investigation Workflow Error Verify");
