...
public class IntakeNarrativeTest_0029 extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(IntakeNarrativeTest_0029.class);

	public IntakeNarrativeTest_0029() throws AcisException {
		super();
	...
	@Test(description = "USS-0029:Intake - Narrative Intake Test", groups = { "Medium", "ACIS_Regression", "Akash" })
