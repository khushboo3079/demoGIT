...
public class SearchPersonTest_0613 extends TestBase {

	final static Logger logger = LoggerFactory.getLogger(SearchPersonTest_0613.class);

	public SearchPersonTest_0613() throws AcisException {
		super();
	...
	public void submitNewAllegation() throws AcisException, InterruptedException, IOException {
		try {
			...
			loginTest.intakeTest.intakeCreationInvestigationWithVictimMaltreator(firstPersonFirstName, firstPersonMiddleName, firstPersonLastName, NewPersonFirstName, NewPersonMiddleName, NewPersonLastName);
...
//				searchPerson_OmniscriptPage.searchRecordVerify(date);
				...
				searchPerson_OmniscriptPage.searchPersonUsingvalidData("firstName", "Krish");
				searchPerson_OmniscriptPage.searchRecordLabelsVerify();
				searchPerson_OmniscriptPage.searchRecordVerify("Krish");
				...
				searchPerson_OmniscriptPage.searchClearText();
				searchPerson_OmniscriptPage.searchPersonUsingMultipleValidData("firstlastName", "Allen",
						"A");
...
//			if (count == 2) 
			{
				...
				reportDetailsOmniscriptPage.setDate("Incident");
				reportDetailsOmniscriptPage.clickNextBtn();
				searchPerson_OmniscriptPage.searchPersonUsingvalidData("lastName", "Krish");
//				searchPerson_OmniscriptPage.searchRecordVerify("A");
//				count++;
			}
