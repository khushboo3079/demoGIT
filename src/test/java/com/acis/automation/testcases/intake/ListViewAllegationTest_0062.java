...
public class ListViewAllegationTest_0062 extends TestBase {

	public ListViewAllegationTest_0062() throws AcisException {
		super();
 ...
 */
	final static Logger logger = LoggerFactory.getLogger(ListViewAllegationTest_0062.class);
