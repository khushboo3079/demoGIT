...
public class IntakePersonBirthdateTest_0060 extends TestBase{

	public IntakePersonBirthdateTest_0060() throws AcisException {
		super();
		// TODO Auto-generated constructor stub
	}

	
	final static Logger logger = LoggerFactory.getLogger(IntakePersonBirthdateTest_0060.class);
	
	
	@Test(description = "US-0060 : Capture Intake Person's Birthdate", groups = { "High",
