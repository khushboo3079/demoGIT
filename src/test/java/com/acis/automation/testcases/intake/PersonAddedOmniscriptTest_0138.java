...
public class PersonAddedOmniscriptTest_0138 extends TestBase{

	final static Logger logger = LoggerFactory.getLogger(PersonAddedOmniscriptTest_0138.class);
	public PersonAddedOmniscriptTest_0138() throws AcisException {
		super();
		...
		@Test(description = "US-0138:PersonAdded OmniScript - Supervisor", groups = { "Simple", "ACIS_Regression", "Khushboo" })
		  public void personAddedOmniscript() throws AcisException, InterruptedException, IOException {
