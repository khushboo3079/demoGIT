...
public class OverrideScreeningDecisionTest extends TestBase {

	public OverrideScreeningDecisionTest() throws AcisException {
		super();
	 ...
	 */
	final static Logger logger = LoggerFactory.getLogger(OverrideScreeningDecisionTest.class);
	String allegationID;

	@Test(enabled=true,description = "US:0039 Overriding Screening Decission using supervisorLogin", groups = { "High",
