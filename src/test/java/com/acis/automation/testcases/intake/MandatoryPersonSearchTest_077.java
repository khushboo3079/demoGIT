...
public class MandatoryPersonSearchTest_077 extends TestBase{
	
	final static Logger logger = LoggerFactory.getLogger(MandatoryPersonSearchTest_077.class);
	public MandatoryPersonSearchTest_077() throws AcisException {
		super();
