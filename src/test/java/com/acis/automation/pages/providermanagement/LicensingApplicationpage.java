...
public class LicensingApplicationpage extends PageBase {

	public LicensingApplicationpage() throws AcisException {
	...
	public static Logger logger = LoggerFactory.getLogger(LicensingApplicationpage.class);
