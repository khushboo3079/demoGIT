...
public class SearchPerson_OmniscriptPage extends PageBase {
	...
	@FindBy(xpath = "//*[@data-omni-key='PersonsSearch']//h1[text()[contains(.,'Person(s) Involved')]]")
 ...
 */
	 ...
	 * @throws InterruptedException
	 */
	public void selectPerson(String firstName, String lastName , String roleOption , String primaryCaregiverOption) throws AcisException, InterruptedException {

		logger.info("Selecting person : " + firstName + " " + lastName);
		waitForElement(selectFirstRecordCheckBox);
		clickWebElemntUsingJavascriptExecutor(driver.findElement(By.xpath("//*[text()='"+ lastName+"']/../..//*[text()='"+ firstName+"']/..//span[contains(@class,'radio')]")));
